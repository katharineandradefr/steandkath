  ...
  return (
    <div ref={containerRef} className="relative shrink-0">
      ...
      {open && (
        <div
          role="menu"
          className="absolute top-full right-0 z-20 mt-2 w-64 overflow-hidden rounded-2xl bg-white py-2 shadow-lg"
        >
          {activeCategory === null ? (
            <>
              <div className="border-b border-gray-100 px-2 pb-2">
                <button
                  ...
                  onClick={clearAll}
                  className="w-full rounded-lg px-3 py-2 text-left text-sm text-calendar-bordeaux transition-colors hover:bg-gray-100 focus-visible:bg-gray-100 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-40"
                >
                  Limpar tudo
                </button>
              </div>
                  ...
                  return (
                    <li key={category}>
                      <button
                        ...
                        className="flex w-full items-center justify-between gap-2 px-4 py-2.5 text-left text-sm text-gray-700 transition-colors hover:bg-gray-100 focus-visible:bg-gray-100 focus-visible:outline-none"
                      >
            ...
            <>
              <button
                ...
                className="flex w-full items-center gap-1 border-b border-gray-100 px-4 py-2.5 text-left text-sm font-medium text-calendar-bordeaux transition-colors hover:bg-gray-100 focus-visible:bg-gray-100 focus-visible:outline-none"
              >
                <ChevronLeft className="h-4 w-4" aria-hidden />
                {CATEGORY_LABELS[activeCategory]}
              </button>
              <ul className="max-h-64 overflow-y-auto py-1">
                {activeCategory === "urgency" &&
  ...
  return (
    <li>
      <button
        ...
        onClick={onToggle}
        className="flex w-full items-center gap-3 px-4 py-2.5 text-left text-sm text-gray-700 transition-colors hover:bg-gray-100 focus-visible:bg-gray-100 focus-visible:outline-none"
      >
        <span
